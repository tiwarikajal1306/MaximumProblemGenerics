...
public class GenericProblemCheck {
    ...
    public void givenThreeInteger_FirstPosition_ShouldReturnMaximum() {
        ...
        Assert.assertEquals(Array[0],new MaximumProblemGenericServices(Array).maximumValue());
    }
    @Test
    public void givenThreeInteger_SecondPosition_ShouldReturnMaximum() {
        Integer[] Array = {20,30,10};
        Assert.assertEquals(Array[1],new MaximumProblemGenericServices(Array).maximumValue());
    }
    @Test
    public void givenThreeInteger_ThirdPosition_ShouldReturnMaximum() {
        Integer[] Array = {10,20,80,50,45,76};
        Assert.assertEquals(Array[2],new MaximumProblemGenericServices(Array).maximumValue());
    }
    @Test
